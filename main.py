...
BOT_TOKEN = "8287397505:AAECZxYCE4yONBJVd670FAGbNByRxgW3lfo"
ADMIN_ID = 7745665836
ADMINS = [7745665836]
DEFAULT_SMS_API = "http://whatjunaid-production.up.railway.app/api/?type=sms"
...
GROUP_KEYBOARD = InlineKeyboardMarkup([
    [
        InlineKeyboardButton("📱 Channel", url="https://t.me/ahmadearningcenter"),
        InlineKeyboardButton("☎️ Number", url="https://t.me/ahmadtricks"),
    ],
    [
        InlineKeyboardButton("💻 DEVELOPER", url="https://t.me/ahmedearningcenter"),
        InlineKeyboardButton("🟢 Whatsapp", url="https://whatsapp.com/channel/0029Vb6oCN0F1Ylbxpk2eh10"),
    ],
])
...
async def callback_handler(update: Update, context):
    ...
    if data == "check_join":
        ...
        kb = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton("\U0001f4f1 OTP Group", url="https://t.me/ahmad_tricks")],
        ])
